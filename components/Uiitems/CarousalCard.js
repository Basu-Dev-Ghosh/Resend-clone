...
export default function CarousalCard() {
  return (
    <div className="w-[400px] h-[200px] flex flex-col items-center bg-[#0B0B0B] rounded-lg border border-gray-800 mx-6  px-4">
      ...
      <Image src={vercel} width={30} height={30} className="rounded-lg"/>
      <Image src={vercel_owner} width={30} height={30} className="rounded-lg"/>
      </div>
